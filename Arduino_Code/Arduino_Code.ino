...
// ==========================================
const char* WIFI_SSID = ".id-za"; //nama SSID WIFI
const char* WIFI_PASS = ".idzaaaaa"; //PASSWORD WIFI
...
const char* BROKER1_USER = "Gzza-web-client";
const char* BROKER1_PASS = "Abangaba11";
...
const char* BROKER2_USER = "ldaBtdafTVhQH6feMcpfdwVxYVmNfYQAb1wSLICn4AykmdC5xy4JY2SPPhI1h7yb";
const char* BROKER2_PASS = "";

// ==========================================
// DETAIL DATA INTEGRASI BROKER 3: SHIFTR
// ==========================================
const char* BROKER3_HOST = "Gusliza.cloud.shiftr.io";
const int   BROKER3_PORT = 8883;
const char* BROKER3_USER = "gusliza";
const char* BROKER3_PASS = "Abangaba11";
